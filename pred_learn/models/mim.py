...
from pred_learn.layers.SpatioTemporalLSTMCellv2 import SpatioTemporalLSTMCell as stlstm
from pred_learn.layers.DiffSpatioTemporalLSTMCell import DiffSpatioTemporalLSTMCell as diffstlstm
from pred_learn.layers.ConvLSTMCellPeephole import ConvLSTMCell as lstm
import math
...
def mim(images, params, schedual_sampling_bool, num_layers, num_hidden, filter_size,
    ...
    for i in range(num_layers):
        ...
        if i < 1:
            ...
            new_stlstm_layer = diffstlstm('stlstm_' + str(i + 1),
                                          filter_size,
                                          num_hidden_in,
                                          num_hidden[i],
                                          shape,
